        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="col-sm-1 col-md-2">
                    <a class="btn btn-primary btn-sm" href="{{ route('cards.create') }}">اضافة بطاقة جديدة</a>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('cards.show', $card->id) }}" class="btn btn-sm btn-secondary"
                                            title="عرض الانواع"><i class="las la-grip-horizontal"></i></a>

                                        @if ($card->status == true)
                                            <a href="{{ route('change-card-status', $card->id) }}"
                                                class="btn btn-sm btn-warning" title="الغاء تفعيل البطاقة"><i
                                                    class="las la-bell-slash"></i></a>
                                        @else
                                            <a href="{{ route('change-card-status', $card->id) }}"
                                                class="btn btn-sm btn-success" title="تفعيل البطاقة"><i
                                                    class="las la-bell"></i></a>
                                        @endif
                                        <div class="btn btn-group">
                                            <a href="{{ route('cards.edit', $card->id) }}" class="btn btn-sm btn-info"
