        ...
        <div class="card">
            <div class="input-group">
                <input type="text" id="myInput" onkeyup="myFunction()"
                    placeholder="ابحث في البطاقات عن نوع بطاقة ما" title="Type in a name" class="form-control" />
            </div>
        </div>
    </div>
    <div class="col-lg-4 col-md-6">
        <div class="card">
            <div class="input-group">
                <input type="text" id="secondInput" onkeyup="secondFunction()"
                    placeholder="ابحث في البطاقات عن عن رابط Paypal" title="Type in a link" class="form-control" />
            </div>
        </div>
    </div>
    <div class="col-lg-4 col-md-6">
        <div class="card">
            <div class="input-group">
                <input type="text" id="thirdInput" onkeyup="thirdFunction()"
                    placeholder="ابحث في البطاقات عن رقم تحويل محدد" title="Type in a transection number"
                    class="form-control" />
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-3 col-md-3">
        <div class="card">
            <a href="{{ route('export-custom-card-approved') }}" class="btn btn-primary">تصدير الجميع</a>
        </div>
    </div>
    <div class="col-lg-3 col-md-3">
        <div class="card">
            <a href="{{ route('delete-custom-card-approved') }}" class="btn btn-danger">حذف الجميع</a>
        </div>
    </div>
</div>
