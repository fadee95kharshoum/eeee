...
<div class="row">
    <div class="col-lg-3 col-md-3">
        <div class="card">
            <a href="{{ route('export-custom-card-rejected') }}" class="btn btn-primary">تصدير الجميع</a>
        </div>
    </div>
    <div class="col-lg-3 col-md-3">
        <div class="card">
            <a href="{{ route('delete-custom-card-rejected') }}" class="btn btn-danger">حذف الجميع</a>
        </div>
    </div>
</div>
