...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">البطاقات المرفوعة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    قائمة البطاقات المرفوعة</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="col-sm-1 col-md-2">
                        <p>يمكنك أن تقوم بالبحث في البطاقات المعلقة :</p>
                    </div>
                </div>
                <livewire:card-type />
            </div>
