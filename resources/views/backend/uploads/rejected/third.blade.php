...
<ul class="nav nav-tabs mb-3">
    ...
    <li class="nav-item">
        <a class="nav-link" aria-current="page" href="{{ route('type-rejected', $card->id) }}">{{ $card->name }}</a>
      </li>
    @endforeach
  ...
  <ul class="nav nav-tabs mb-3">
    ...
    <li class="nav-item">
        <a class="nav-link" aria-current="page" href="{{ route('uploads-rejected', $type->id) }}">{{ $type->name }}</a>
      </li>
    @endforeach
...
<div class="row">
    ...
    <div class="col-lg-3 col-md-3">
        <div class="card">
            <a href="{{ route('ExportRejected', $type_selected) }}" class="btn btn-primary">تصدير الجميع</a>
        </div>
    </div>
    <div class="col-lg-3 col-md-3">
        <div class="card">
            <a href="{{ route('DeleteRejected', $type_selected) }}" class="btn btn-danger">حذف الجميع</a>
        </div>
    </div>
</div>
    <!-- row opened -->
