                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if ($user->status == 1)
                                        <a href="{{ route('change-user-status', $user->id) }}"
                                            class="btn btn-sm btn-warning" title="الغاء تفعيل حساب"><i
                                                class="las la-bell-slash"></i></a>
                                        @else
                                        <a href="{{ route('change-user-status', $user->id) }}" class="btn btn-sm btn-success"
                                            title="تفعيل حساب"><i class="las la-bell"></i></a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
