...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">طرق الدفع</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                تعديل طريقة الدفع</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="card-body">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-right">
                        <a class="btn btn-primary btn-sm" href="{{ route('payments.index') }}">رجوع</a>
                    </div>
                </div><br>
                ...
                <form action="{{ route('payments.update', $payment->id) }}" method="POST">
                    ...
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-6" id="fnWrapper">
                            ...
                            <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                name="name" required type="text" value="{{ $payment->name }}">
                        </div>

                        <div class="parsley-input col-md-6" id="fnWrapper">
                            <label>أدخل الرقم السري<span class="tx-danger"></span></label>
                            <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                name="number" required type="text" value="{{ $payment->number }}">
                        </div> 
                    ...
                    <div class="form-check m-2">
                        <button type="submit" class="btn btn-primary btn-loading">تحديث طريقة</button>
                    </div>
                </form>
            </div>
        </div>
