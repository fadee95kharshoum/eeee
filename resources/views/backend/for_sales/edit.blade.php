...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"> البطاقات المطروجة للبيع</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                تعديل بطاقات</span>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('cards-for-sale.update', $card->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-6" id="fnWrapper">
                            ...
                            <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                name="name" required type="text" value="{{ $card->name }}">
                        </div>

                        <div class="parsley-input col-md-6" id="fnWrapper">
                            <label>أدخل وصف البطاقة<span class="tx-danger"></span></label>
                            <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                name="description" required type="text" value="{{ $card->description }}">
                        </div>
                    </div>
                    <div class="row mg-b-20">
                    ...
                    <div class="form-check m-2">
                        <button type="submit" class="btn btn-primary btn-loading">تحديث </button>
                    </div>
                </form>
            </div>
        </div>
